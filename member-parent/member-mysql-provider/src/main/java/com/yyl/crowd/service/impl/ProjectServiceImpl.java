...
import com.yyl.crowd.entity.po.MemberConfirmInfoPO;
import com.yyl.crowd.entity.po.MemberLaunchInfoPO;
import com.yyl.crowd.entity.po.ProjectPO;
import com.yyl.crowd.entity.po.ReturnPO;
import com.yyl.crowd.entity.vo.*;
import com.yyl.crowd.mapper.*;
...
public class ProjectServiceImpl implements ProjectService {
     ...
     */
    @Override
    public List<PortalProjectVO> getAllProject(){
    ...
    public DetailProjectVO getDetailProjectVO(Integer projectId) {
        ...
        switch (status) {
            case 0: detailProjectVO.setStatusText("审核中");
            break;
            case 1: detailProjectVO.setStatusText("众筹中");
            break;
            case 2: detailProjectVO.setStatusText("众筹成功");
            break;
            case 3: detailProjectVO.setStatusText("已关闭");
            break;
        ...
        try {
            ...
            Date data = format.parse(deployDate);


            // 获取当前当前日期的时间戳
            long currentTimeStamp = currentDay.getTime();
            // 获取众筹日期的时间戳
            long deployTimeStamp = data.getTime();
            // 两个时间戳相减计算当前已经过去的时间
