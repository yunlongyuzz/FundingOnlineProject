package com.yyl.crowd.constant;
...
public class CrowdConstant {
    ...
    public static final String MESSAGE_ACCESS_DENIED="抱歉，你不配访问!";
    ...
    public static final String ATTR_NAME_DETAIL_DATA = "detail_data";

    public static final String ATTR_NAME_TEMPLE_PROJECT = "templeProject";
    public static final String MESSAGE_RETURN_MISSING = "回报不能为空！";
